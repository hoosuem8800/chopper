      ...
      <div className="w-full mx-auto pt-8 flex flex-col items-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full justify-items-center">
          ...
          <div className="space-y-4 flex flex-col items-center text-center">
            <h3 className="text-sm font-bold text-gray-800 pb-1 border-b-2 animated-border w-36 text-center">
              Get in touch
            </h3>
            <ul className="text-gray-600 text-sm w-full max-w-xs">
              <li className="flex items-center gap-3 transition-all duration-300 p-2.5 rounded-lg hover:text-cyan-500 hover:shadow-md group contact-item-hover">
                <div className="p-2 rounded-full bg-cyan-500 text-white group-hover:bg-white group-hover:text-cyan-500 group-hover:shadow-md transition-all duration-300 animated-icon-container">
                  <MapPin className="h-5 w-5 map-pin-icon" />
                </div>
          ...
          <div className="space-y-3 flex flex-col items-center text-center">
            <h3 className="text-sm font-bold text-gray-800 pb-1 border-b-2 animated-border w-36 flex items-center justify-center gap-1">
              CHOPPER
              <LungsIcon className="h-4 w-4 text-cyan-500" />
            </h3>
            <p className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-cyan-500 to-cyan-400 max-w-sm mx-auto text-base font-medium italic leading-relaxed tracking-wide">
        ...
        <div className="border-t border-gray-200 w-full mt-4">
          <div className="text-center text-white text-xs bg-cyan-500 py-2 w-full font-bold">
